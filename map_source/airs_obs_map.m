%
% NAME
%   airs_obs_map - equal area map directly from AIRS data
%
% SYNOPSIS
%   airs_obs_map(year, dlist, ofile, opt1)
%
% INPUTS
%   year   - year, as an integer
%   dlist  - list of days-of-the-year
%   ofile  - save file for maps
%   opt1   - input options
%
% DISCUSSION
%   derived from airs_obs_list, works from a channel list
%
% AUTHOR
%  H. Motteler, 3 July 2017
%

function airs_obs_map(year, dlist, ofile, opt1)

% defaults
adir = '/asl/data/airs/L1C';   % path to AIRS data
ixt = 1 : 90;   % full scans
nLat = 24;      % number of latitude bands, equator to pole
dLon = 4;       % longitude band width in degrees
...
% build the equal area map
[latB1, lonB1, gtot, gavg, gsqr] = ...
    equal_area_bins(nLat, dLon, lat_list, lon_list, rad_list);

% save map and associated data
save(ofile, 'year', 'dlist', 'adir', 'ixt', 'ixv', 'vlist', ...
     'nLat', 'dLon', 'latB1', 'lonB1', 'gtot', 'gavg', 'gsqr');
