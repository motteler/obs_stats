%
% cris_map_batch - batch wrapper for cris_map_list
%

% function cris_map_batch(year)
...
fprintf(1, 'cris_batch: year %d set %d node %d\n', year, taskid, nodeid);
...
opt1 = struct;
  ...
  opt1.cdir = '/asl/data/cris/ccast/sdr60_npp_HR';
