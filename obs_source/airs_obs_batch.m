...
tfile = sprintf('airs_c04y%ds%0.2d', year, taskid);

% airs_obs_list options
opt1 = struct;
opt1.adir = '/asl/airs/l1c_v672';  % path to AIRS data
...
% Huang's channel set cH
% opt1.vlist = [831.64 832.02 832.41 834.76 836.74 846.32 ...
%               846.72 847.13 847.94 860.48 861.11 863.00];
