%
% NAME
%   cris_sdr2map - equal area map directly from CrIS data
%
% SYNOPSIS
...
%
% DISCUSSION
%   ** IN PROGRESS ** this is just a copy of an earlier version of
%   cris_obs_list, to keep the subsetting from there we need to make
%   maps directly
%
% AUTHOR
